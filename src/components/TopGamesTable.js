...
const data = [
  createData("PLAYERUNKNOWN'S BATTLEGROUNDS", "529,305", "1,109,766", "326,072,128"),
  createData("Dota 2", "373,188", "797,132", "320,915,067"),
  createData("Counter-Strike: Global Offensive", "221,553 ","746,548", "270,159,786"),
  createData("Tom Clancy's Rainbow Six Siege", "58,359", "121,524", "47,360,339"),
